    ...
    <footer>
      <div className="wrap">
        <div className="foot-top">
          ...
          <div className="foot-col">
            <h5>Company</h5>
            <a href="#process">How we work</a><a href="#sectors">Sectors</a><a href="#projects">Projects</a><a href="#why">Why Temasek</a><a href="#enquiry">Contact</a>
          </div>
          <div className="foot-col">
            <h5>Offices</h5>
            <span className="li">Unit No-207,The Solitaire Plaza, Sikandarpur,sector-26, Gurugram, Haryana-122002</span>
            {/* <span className="li">Chennai — Tamil Nadu</span> */}
            <span className="li">Info@temasekres.com</span>
            <span className="li">+91 7827479548</span>
          </div>
        </div>
        <div className="foot-bot">
          <p>© {new Date().getFullYear()} Temasek Resources Pvt Ltd. All rights reserved.</p>
